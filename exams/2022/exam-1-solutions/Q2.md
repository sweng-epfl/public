...
each time a small "sub-feature" is ready. [4 pts]
...
and most of all, there won't be any "but it worked on my computer" syndrome since the environment is standardized. [7 pts]
