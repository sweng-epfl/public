...
This exam comes from the `final-GASPAR` repo in the `sweng-epfl` GitHub organization.
...
The exam is worth 100 points in total, and you have 165 minutes (2 hours and 45 minutes) to complete it. The exam consists of two parts:
