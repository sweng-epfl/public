...
public final class GradingTest {
    ...
    public final double availablePoints;
    ...
    public GradingTest(final String name, final String details, final double availablePoints, final GradingPoints.PointsFormat pointsFormat) {
        this.name = name;
