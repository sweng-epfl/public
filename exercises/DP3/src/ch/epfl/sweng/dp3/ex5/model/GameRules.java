package ch.epfl.sweng.dp3.ex5.model;

/**
 * Contains the main functionality of comparing gestures
 * and deciding the outcome of the game.
 */
public class GameRules	{
    ...
    /**
     * Compares two given gestures and decides if there is a winner or not and in case
     * of a winner who it is.
     * @param a gesture of first player.
     * @param b gesture of second player.
     * @return 0 if there is a draw between the two players. Or -1 in case the first
     * player wins the second player; 1 in case second player wins the first one.
