package ch.epfl.sweng.dp3.solutions.ex5.controller;
...
import ch.epfl.sweng.dp3.solutions.ex5.view.View;

/**
 * Class that takes input from the user (either GUI or text-based) and
 * decides how the view and/or the model is changed.
 */
public class Controller {
     ...
     * @throws IllegalArgumentException thrown in case type of the game is not
     * known or null.
     */
