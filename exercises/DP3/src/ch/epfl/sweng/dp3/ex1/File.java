...
public class File {
    ...
    public String getHash(String hashFunction) throws OperationNotSupportedException {
        ...
        if (hashFunction.compareTo("SIMPLE") == 0) {
            ...
            throw new OperationNotSupportedException("Only SIMPLE and SHA-256 hash functions are currently supported");
        }
    }
    ...
    private String getSHA256Hash() {
        ...
        // code snippet taken from https://stackoverflow.com/questions/5470219/get-md5-string-from-message-digest
