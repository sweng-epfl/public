import model.*;
import model.thread.THDDistantCredentialDatabase;
...
public class THDDistantCredentialDatabaseTest {
    ...
    public void tryToAuthUserThatDoesNotExistThrowsUnknownUser() throws InterruptedException {
        THDDistantCredentialDatabase db = new THDDistantCredentialDatabase();
    ...
    public void callAddUserOnEmptyDBAddsUserToDB() throws InterruptedException {
        ...
        assertThat(callback.users.element().getSciper(), is("1234"));
    }
